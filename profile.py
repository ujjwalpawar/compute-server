...
for i in range(0,params.machineNum):
    ...
    node.addService(PG.Execute(shell="bash", command="PROFILE_CONF_COMMAND_ISOLCPU=\"/local/repository/scripts/isolcpus.sh\" PROFILE_CONF_COMMAND_ISOLCPU_ARGS=\"2 yes\" /local/repository/scripts/configure.sh"))
